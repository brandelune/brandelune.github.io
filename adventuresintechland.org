...
** DONE create the rss entry in adventuresintechland.xml                 :me:
...
** DONE run =adventuresintechland_old.el= to create the template      :emacs:
...
** DONE fill the template with the stuff I did                           :me:
